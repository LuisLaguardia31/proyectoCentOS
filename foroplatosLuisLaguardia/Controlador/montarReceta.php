    ...
    for($i=0;$i<count($recetas);$i+=2){
        ...
        if(empty($recetas[$i+1])){
            ...
            switch($recetas[$i]["dificultad"]){
                case "facil":
                    echo '<p><strong>Dificultad:</strong> Facil</p>';
                    break;
                case "medio":
                    echo '<p><strong>Dificultad:</strong> Medio</p>';
                    break;
                case "dificil":
                    echo '<p><strong>Dificultad:</strong> Dificil</p>';
                    break;
                default:
                    echo '<p><strong>Dificultad:</strong> Muy Dificil</p>';
                    break;
            }
