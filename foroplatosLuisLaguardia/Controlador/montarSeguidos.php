<?php
    include ("../Controlador/controlSeguidos.php");

    $usuarios = seguidos($_SESSION["idUsuario"], $primerUsuario, $tamanioPagina);
    ...
    foreach($usuarios as $usuario){
        ...
        if(seSiguen($_SESSION["idUsuario"],$usuario["id"])){
            ...
            echo '<input type="submit" name="siguiendo" value="Dejar de Seguir">';
            echo '</form>';
        }
	...
	if($numPagina!=$maxPagina &&  count(seguidos($_SESSION["idUsuario"],($numPagina+1)*$tamanioPagina, $tamanioPagina))!=0){
