...
<body>
    ...
    <nav class="menu">
        <ul>
            ...
            <li><a href="../Controlador/crearReceta.php">Crear Receta</a></li>
            <li><a href="../Controlador/verSeguidores.php">Seguidores</a></li>
            <li><a href="../Controlador/verSeguidos.php">Seguidos</a></li>
            <li><a href="../Controlador/administracionUsuarios.php">Administrar Usuarios</a></li>
        </ul>
    ...
    <main>
        <?php
            ...
            include("../Controlador/montarRecetaRegistrado.php");           
        ?>
    </main>
